...
[Image of pollen grains in water showing Brownian motion]
...
[Image of Brownian motion simulation showing molecular collisions]
...
He derived the formula for the **Mean Squared Displacement (MSD)**, $\langle x^2 
angle$, of a particle after a time $t$:
...
[Image of Einstein's diffusion equation plot]
...
[Image of Jean Perrin's experimental trajectory data]
